This device definition also lies in RobWork/trunk/RobWork/test/testfiles/devices/Robotiq-2-finger-85. The two models should remain identical if possible.
